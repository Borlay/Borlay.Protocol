...
On my laptop it handles more than 10k request per second. It is couple times faster than WCF or .Net Core Rest service. Redis is slower as well. And data serialization is fast and compact.
